# cmem — Portable Project Memory for universalWasmLoader-dart

This folder is the **authoritative, portable project memory** for `universalWasmLoader-dart`. It lives
...
`file:line` + severity, fix the safe ones, and keep the test suite green (`dart test`).
